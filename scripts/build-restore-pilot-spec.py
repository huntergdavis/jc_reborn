...
def build_spec(report: dict, manifest_dir: Path, template_dir: Path, ads_name: str | None) -> dict:
    if ads_name is None:
...
def main() -> int:
    ...
    spec = build_spec(report, args.manifest_dir, args.template_dir, args.ads_name)
