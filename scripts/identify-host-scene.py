...
def compare_scenes(query: dict, candidate: dict) -> dict:
    ...
    if background_only_query:
        ...
        score += token_similarity * 0.05
        score += activity_similarity * 0.05
        score += shared_frame_coverage * 0.025
        score += context_set_similarity * 1.0
    else:
    ...
    score += (1.0 if background_only_query else 5.0) if family_match else 0.0
    score += 0.0 if background_only_query else pose_similarity * 12.0
    score += (2.0 if background_only_query else 8.0) * transition_similarity
    ...
    score += (3.0 if background_only_query else 10.0) * trait_similarity
