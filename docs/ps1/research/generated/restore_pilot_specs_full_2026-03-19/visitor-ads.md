...
- restore score: `85`
- peak memory: `235194`
- union rect: `{'x': 0, 'y': 35, 'width': 65551, 'height': 315}`
- unique rects: `36`
- TTM owners: `GJLILIPU.TTM, GJVIS3.TTM, GJVIS5.TTM, GJVIS6.TTM, MJCOCO.TTM`

## Scene resources

- BMPs: `MJTELE.BMP, MJTELE2.BMP, GJVIS3.BMP, TRUNK.BMP`
- SCRs: `ISLETEMP.SCR`
...
- `GJVIS6.TTM`: rect `{'x': 0, 'y': 43, 'width': 65551, 'height': 307}`, clear regions `[0, 1, 2]`, op counts `{'region_id': 4, 'copy_zone_to_bg': 28, 'save_image1': 3, 'save_zone': 0, 'restore_zone': 0, 'clear_screen': 157}`
