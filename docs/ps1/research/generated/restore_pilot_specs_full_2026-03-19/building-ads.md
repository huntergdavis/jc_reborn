...
- restore score: `91`
- peak memory: `291628`
- union rect: `{'x': 40, 'y': 56, 'width': 600, 'height': 304}`
- unique rects: `11`
- TTM owners: `GJGULIVR.TTM, MJFIRE.TTM, MJSAND.TTM`

## Scene resources

- BMPs: `JOHNWALK.BMP, TRUNK.BMP, FIRE.BMP, FIRE1.BMP, FIRE3.BMP, FIRE4.BMP, FIRE2.BMP`
- SCRs: `ISLETEMP.SCR`
...
- `MJSAND.TTM`: rect `{'x': 40, 'y': 56, 'width': 568, 'height': 304}`, clear regions `[0, 1]`, op counts `{'region_id': 2, 'copy_zone_to_bg': 3, 'save_image1': 2, 'save_zone': 0, 'restore_zone': 0, 'clear_screen': 294}`
